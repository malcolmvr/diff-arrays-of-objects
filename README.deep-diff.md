...
A standard import of `import diff from 'deep-diff'` is assumed in all of the code examples. The import results in an object having the following public properties:
